                                                ...
                                                (let uu___29_452 = s  in
                                                 {
                                                   ...
                                                   FStar_Syntax_Syntax.sigrng
                                                     =
                                                     (uu___29_452.FStar_Syntax_Syntax.sigrng);
                                                   FStar_Syntax_Syntax.sigquals
                                                     =
                                                     (uu___29_452.FStar_Syntax_Syntax.sigquals);
                                                   FStar_Syntax_Syntax.sigmeta
                                                     =
                                                     (uu___29_452.FStar_Syntax_Syntax.sigmeta);
                                                   FStar_Syntax_Syntax.sigattrs
                                                     =
                                                     (uu___29_452.FStar_Syntax_Syntax.sigattrs)
                                                 }), u, guard1)))))))))
                                                  ...
                                                  (let g_uvs =
                                                   ...
                                                   ((let uu___30_1472 = se
                                                        in
                                                     {
                                                       ...
                                                       FStar_Syntax_Syntax.sigrng
                                                         =
                                                         (uu___30_1472.FStar_Syntax_Syntax.sigrng);
                                                       FStar_Syntax_Syntax.sigquals
                                                         =
                                                         (uu___30_1472.FStar_Syntax_Syntax.sigquals);
                                                       FStar_Syntax_Syntax.sigmeta
                                                         =
                                                         (uu___30_1472.FStar_Syntax_Syntax.sigmeta);
                                                       FStar_Syntax_Syntax.sigattrs
                                                         =
                                                         (uu___30_1472.FStar_Syntax_Syntax.sigattrs)
                                                     }), g))))))))))))
    ...
    fun g  ->
      fun tcs  ->
        fun datas  ->
          ...
          let g1 =
            let uu___31_1543 = g  in
            {
              FStar_TypeChecker_Env.guard_f =
                (uu___31_1543.FStar_TypeChecker_Env.guard_f);
              FStar_TypeChecker_Env.deferred =
                (uu___31_1543.FStar_TypeChecker_Env.deferred);
              FStar_TypeChecker_Env.univ_ineqs =
                (tc_universe_vars,
                  (FStar_Pervasives_Native.snd
                     g.FStar_TypeChecker_Env.univ_ineqs));
              FStar_TypeChecker_Env.implicits =
                (uu___31_1543.FStar_TypeChecker_Env.implicits)
            }  in
          (let uu____1553 =
                                                  ...
                                                  (match uu____1963 with
                                                   | (tps1,t3) ->
                                                          ...
                                                          in
                                                       {
                                                         ...
                                                         FStar_Syntax_Syntax.sigrng
                                                           =
                                                           (uu___32_2104.FStar_Syntax_Syntax.sigrng);
                                                         FStar_Syntax_Syntax.sigquals
                                                           =
                                                           (uu___32_2104.FStar_Syntax_Syntax.sigquals);
                                                         FStar_Syntax_Syntax.sigmeta
                                                           =
                                                           (uu___32_2104.FStar_Syntax_Syntax.sigmeta);
                                                         FStar_Syntax_Syntax.sigattrs
                                                           =
                                                           (uu___32_2104.FStar_Syntax_Syntax.sigattrs)
                                                       })
                                              | uu____2109 ->
                                                  failwith "Impossible"))
                                    tc_types tcs
                                                 ...
                                                 (match d.FStar_Syntax_Syntax.sigel
                                                  ...
                                                  | FStar_Syntax_Syntax.Sig_datacon
                                                         ...
                                                         in
                                                      {
                                                        ...
                                                        FStar_Syntax_Syntax.sigrng
                                                          =
                                                          (uu___33_2217.FStar_Syntax_Syntax.sigrng);
                                                        FStar_Syntax_Syntax.sigquals
                                                          =
                                                          (uu___33_2217.FStar_Syntax_Syntax.sigquals);
                                                        FStar_Syntax_Syntax.sigmeta
                                                          =
                                                          (uu___33_2217.FStar_Syntax_Syntax.sigmeta);
                                                        FStar_Syntax_Syntax.sigattrs
                                                          =
                                                          (uu___33_2217.FStar_Syntax_Syntax.sigattrs)
                                                      }
                                                  | uu____2221 ->
                                                      failwith "Impossible"))
                                        data_types datas
               ...
               | (bs2,t2) ->
                   ...
                   let fml1 =
                       ...
                       FStar_Syntax_Syntax.Tm_meta uu____5066  in
                     {
                       ...
                       FStar_Syntax_Syntax.pos =
                         (uu___34_5064.FStar_Syntax_Syntax.pos);
                       FStar_Syntax_Syntax.vars =
                         (uu___34_5064.FStar_Syntax_Syntax.vars)
                     }  in
                   let fml2 =
        ...
        fun mutuals  ->
          fun acc  ->
            fun data  ->
              ...
              and exists_mutual uu___21_6266 =
                match uu___21_6266 with
                | [] -> false
                   ...
                   | (bs2,t2) ->
                       ...
                       let fml1 =
                           ...
                           FStar_Syntax_Syntax.Tm_meta uu____6853  in
                         {
                           ...
                           FStar_Syntax_Syntax.pos =
                             (uu___35_6851.FStar_Syntax_Syntax.pos);
                           FStar_Syntax_Syntax.vars =
                             (uu___35_6851.FStar_Syntax_Syntax.vars)
                         }  in
                       let fml2 =
                         FStar_List.fold_right
                           (fun b  ->
                             ...
                             (fun se  ->
                                let sigel =
                                  ...
                                  | uu____7529 ->
                                   ...
                                   in
                                let uu___36_7531 = se  in
                                {
                                  FStar_Syntax_Syntax.sigel = sigel;
                                  FStar_Syntax_Syntax.sigrng =
                                    (uu___36_7531.FStar_Syntax_Syntax.sigrng);
                                  FStar_Syntax_Syntax.sigquals =
                                    (uu___36_7531.FStar_Syntax_Syntax.sigquals);
                                  FStar_Syntax_Syntax.sigmeta =
                                    (uu___36_7531.FStar_Syntax_Syntax.sigmeta);
                                  FStar_Syntax_Syntax.sigattrs =
                                    (uu___36_7531.FStar_Syntax_Syntax.sigattrs)
                                }) tys
                            in
                         let datas1 =
                           FStar_List.map
                             (fun se  ->
                                let sigel =
                                  ...
                                  | uu____7572 ->
                                      failwith "Impossible, can't happen"
                                   in
                                let uu___37_7574 = se  in
                                {
                                  FStar_Syntax_Syntax.sigel = sigel;
                                  FStar_Syntax_Syntax.sigrng =
                                    (uu___37_7574.FStar_Syntax_Syntax.sigrng);
                                  FStar_Syntax_Syntax.sigquals =
                                    (uu___37_7574.FStar_Syntax_Syntax.sigquals);
                                  FStar_Syntax_Syntax.sigmeta =
                                    (uu___37_7574.FStar_Syntax_Syntax.sigmeta);
                                  FStar_Syntax_Syntax.sigattrs =
                                    (uu___37_7574.FStar_Syntax_Syntax.sigattrs)
                                }) datas
                            in
                         let uu____7575 =
                      ...
                      let arg_binder =
                        ...
                        then unrefined_arg_binder
                          ...
                          (let disc_name =
                           ...
                           let uu____8342 =
                             let uu___38_8343 = projectee arg_typ  in
                             {
                               FStar_Syntax_Syntax.ppname =
                                 (uu___38_8343.FStar_Syntax_Syntax.ppname);
                               FStar_Syntax_Syntax.index =
                                 (uu___38_8343.FStar_Syntax_Syntax.index);
                         ...
                         | (inductive_tps,typ0,should_refine) ->
                             ...
                             (match uu____9925 with
                              | (indices,uu____9943) ->
                                  ...
                                  let fv_qual =
                                    let filter_records uu___28_10000 =
                                      match uu___28_10000 with
                                      | FStar_Syntax_Syntax.RecordConstructor
                                          (uu____10003,fns) ->
                                          FStar_Pervasives_Native.Some
