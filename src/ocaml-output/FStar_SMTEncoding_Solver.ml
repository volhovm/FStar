  ...
  fun e  ->
    fun theory  ->
      ...
      let pruned_theory =
        ...
        let keep_decl uu___17_442 =
          match uu___17_442 with
...
let (report_errors : query_settings -> unit) =
  fun settings  ->
    ...
    (let uu____2258 =
     ...
     then
       let initial_fuel1 =
         let uu___19_2267 = settings  in
         let uu____2268 = FStar_Options.initial_fuel ()  in
         let uu____2270 = FStar_Options.initial_ifuel ()  in
         {
           query_env = (uu___19_2267.query_env);
           query_decl = (uu___19_2267.query_decl);
           query_name = (uu___19_2267.query_name);
           query_index = (uu___19_2267.query_index);
           query_range = (uu___19_2267.query_range);
           query_fuel = uu____2268;
           query_ifuel = uu____2270;
           query_rlimit = (uu___19_2267.query_rlimit);
           query_hint = FStar_Pervasives_Native.None;
           query_errors = (uu___19_2267.query_errors);
           query_all_labels = (uu___19_2267.query_all_labels);
           query_suffix = (uu___19_2267.query_suffix);
           query_hash = (uu___19_2267.query_hash)
         }  in
       let ask_z3 label_assumptions =
         let res = FStar_Util.mk_ref FStar_Pervasives_Native.None  in
         (let uu____2293 =
            ...
            (let uu____3495 =
             ...
             | (default_settings,next_hint) ->
                 let use_hints_setting =
                   ...
                   | FStar_Pervasives_Native.Some
                       { FStar_Util.hint_name = uu____3638;
                         ...
                         FStar_Util.hash = h;_}
                       ->
                       [(let uu___20_3660 = default_settings  in
                         {
                           query_env = (uu___20_3660.query_env);
                           query_decl = (uu___20_3660.query_decl);
                           query_name = (uu___20_3660.query_name);
                           query_index = (uu___20_3660.query_index);
                           query_range = (uu___20_3660.query_range);
                           query_fuel = i;
                           query_ifuel = j;
                           query_rlimit = (uu___20_3660.query_rlimit);
                           query_hint = (FStar_Pervasives_Native.Some core);
                           query_errors = (uu___20_3660.query_errors);
                           query_all_labels = (uu___20_3660.query_all_labels);
                           query_suffix = (uu___20_3660.query_suffix);
                           query_hash = (uu___20_3660.query_hash)
                         })]
                   | uu____3664 -> []  in
                 let initial_fuel_max_ifuel =
                   ...
                   then
                     let uu____3679 =
                       let uu___21_3680 = default_settings  in
                       let uu____3681 = FStar_Options.max_ifuel ()  in
                       {
                         query_env = (uu___21_3680.query_env);
                         query_decl = (uu___21_3680.query_decl);
                         query_name = (uu___21_3680.query_name);
                         query_index = (uu___21_3680.query_index);
                         query_range = (uu___21_3680.query_range);
                         query_fuel = (uu___21_3680.query_fuel);
                         query_ifuel = uu____3681;
                         query_rlimit = (uu___21_3680.query_rlimit);
                         query_hint = (uu___21_3680.query_hint);
                         query_errors = (uu___21_3680.query_errors);
                         query_all_labels = (uu___21_3680.query_all_labels);
                         query_suffix = (uu___21_3680.query_suffix);
                         query_hash = (uu___21_3680.query_hash)
                       }  in
                     [uu____3679]
                   else []  in
                 let half_max_fuel_max_ifuel =
                   ...
                   then
                     let uu____3700 =
                       let uu___22_3701 = default_settings  in
                       let uu____3702 =
                         let uu____3704 = FStar_Options.max_fuel ()  in
                         uu____3704 / (Prims.parse_int "2")  in
                       let uu____3707 = FStar_Options.max_ifuel ()  in
                       {
                         query_env = (uu___22_3701.query_env);
                         query_decl = (uu___22_3701.query_decl);
                         query_name = (uu___22_3701.query_name);
                         query_index = (uu___22_3701.query_index);
                         query_range = (uu___22_3701.query_range);
                         query_fuel = uu____3702;
                         query_ifuel = uu____3707;
                         query_rlimit = (uu___22_3701.query_rlimit);
                         query_hint = (uu___22_3701.query_hint);
                         query_errors = (uu___22_3701.query_errors);
                         query_all_labels = (uu___22_3701.query_all_labels);
                         query_suffix = (uu___22_3701.query_suffix);
                         query_hash = (uu___22_3701.query_hash)
                       }  in
                     [uu____3700]
                   else []  in
                 let max_fuel_max_ifuel =
                   ...
                   then
                     let uu____3733 =
                       let uu___23_3734 = default_settings  in
                       let uu____3735 = FStar_Options.max_fuel ()  in
                       let uu____3737 = FStar_Options.max_ifuel ()  in
                       {
                         query_env = (uu___23_3734.query_env);
                         query_decl = (uu___23_3734.query_decl);
                         query_name = (uu___23_3734.query_name);
                         query_index = (uu___23_3734.query_index);
                         query_range = (uu___23_3734.query_range);
                         query_fuel = uu____3735;
                         query_ifuel = uu____3737;
                         query_rlimit = (uu___23_3734.query_rlimit);
                         query_hint = (uu___23_3734.query_hint);
                         query_errors = (uu___23_3734.query_errors);
                         query_all_labels = (uu___23_3734.query_all_labels);
                         query_suffix = (uu___23_3734.query_suffix);
                         query_hash = (uu___23_3734.query_hash)
                       }  in
                     [uu____3733]
                   else []  in
                 let min_fuel1 =
                   ...
                   then
                     let uu____3753 =
                       let uu___24_3754 = default_settings  in
                       let uu____3755 = FStar_Options.min_fuel ()  in
                       {
                         query_env = (uu___24_3754.query_env);
                         query_decl = (uu___24_3754.query_decl);
                         query_name = (uu___24_3754.query_name);
                         query_index = (uu___24_3754.query_index);
                         query_range = (uu___24_3754.query_range);
                         query_fuel = uu____3755;
                         query_ifuel = (Prims.parse_int "1");
                         query_rlimit = (uu___24_3754.query_rlimit);
                         query_hint = (uu___24_3754.query_hint);
                         query_errors = (uu___24_3754.query_errors);
                         query_all_labels = (uu___24_3754.query_all_labels);
                         query_suffix = (uu___24_3754.query_suffix);
                         query_hash = (uu___24_3754.query_hash)
                       }  in
                     [uu____3753]
                   else []  in
                 let all_configs =
                 ...
                 let check_all_configs configs =
                   let report1 errs =
                     report_errors
                       (let uu___25_3814 = default_settings  in
                        {
                          query_env = (uu___25_3814.query_env);
                          query_decl = (uu___25_3814.query_decl);
                          query_name = (uu___25_3814.query_name);
                          query_index = (uu___25_3814.query_index);
                          query_range = (uu___25_3814.query_range);
                          query_fuel = (uu___25_3814.query_fuel);
                          query_ifuel = (uu___25_3814.query_ifuel);
                          query_rlimit = (uu___25_3814.query_rlimit);
                          query_hint = (uu___25_3814.query_hint);
                          query_errors = errs;
                          query_all_labels = (uu___25_3814.query_all_labels);
                          query_suffix = (uu___25_3814.query_suffix);
                          query_hash = (uu___25_3814.query_hash)
                        })
                      in
