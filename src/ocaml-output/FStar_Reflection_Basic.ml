...
let (set_sigelt_attrs :
  ...
  fun attrs  ->
    fun se  ->
      let uu___17_1583 = se  in
      {
        FStar_Syntax_Syntax.sigel = (uu___17_1583.FStar_Syntax_Syntax.sigel);
        FStar_Syntax_Syntax.sigrng =
          (uu___17_1583.FStar_Syntax_Syntax.sigrng);
        FStar_Syntax_Syntax.sigquals =
          (uu___17_1583.FStar_Syntax_Syntax.sigquals);
        FStar_Syntax_Syntax.sigmeta =
          (uu___17_1583.FStar_Syntax_Syntax.sigmeta);
