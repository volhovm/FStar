...
let (uu___is_SetOptions : pragma -> Prims.bool) =
  fun projectee  ->
    match projectee with | SetOptions _0 -> true | uu____83 -> false
  
let (__proj__SetOptions__item___0 : pragma -> Prims.string) =
  fun projectee  -> match projectee with | SetOptions _0 -> _0 
let (uu___is_ResetOptions : pragma -> Prims.bool) =
  fun projectee  ->
    match projectee with | ResetOptions _0 -> true | uu____109 -> false
...
let (uu___is_PushOptions : pragma -> Prims.bool) =
  fun projectee  ->
    match projectee with | PushOptions _0 -> true | uu____141 -> false
...
let (uu___is_PopOptions : pragma -> Prims.bool) =
  fun projectee  ->
    match projectee with | PopOptions  -> true | uu____169 -> false
  
let (uu___is_LightOff : pragma -> Prims.bool) =
  fun projectee  ->
    match projectee with | LightOff  -> true | uu____180 -> false
...
let (uu___is_ET_abstract : emb_typ -> Prims.bool) =
  fun projectee  ->
    match projectee with | ET_abstract  -> true | uu____220 -> false
  
let (uu___is_ET_fun : emb_typ -> Prims.bool) =
  fun projectee  ->
    match projectee with | ET_fun _0 -> true | uu____236 -> false
...
let (uu___is_ET_app : emb_typ -> Prims.bool) =
  fun projectee  ->
    match projectee with | ET_app _0 -> true | uu____275 -> false
...
let (uu___is_U_zero : universe -> Prims.bool) =
  fun projectee  ->
    match projectee with | U_zero  -> true | uu____387 -> false
  
let (uu___is_U_succ : universe -> Prims.bool) =
  fun projectee  ->
    match projectee with | U_succ _0 -> true | uu____399 -> false
...
let (uu___is_U_max : universe -> Prims.bool) =
  fun projectee  ->
    match projectee with | U_max _0 -> true | uu____421 -> false
...
let (uu___is_U_bvar : universe -> Prims.bool) =
  fun projectee  ->
    match projectee with | U_bvar _0 -> true | uu____448 -> false
...
let (uu___is_U_name : universe -> Prims.bool) =
  fun projectee  ->
    match projectee with | U_name _0 -> true | uu____471 -> false
...
let (uu___is_U_unif : universe -> Prims.bool) =
  fun projectee  ->
    match projectee with | U_unif _0 -> true | uu____499 -> false
...
let (uu___is_U_unknown : universe -> Prims.bool) =
  fun projectee  ->
    match projectee with | U_unknown  -> true | uu____542 -> false
...
let (uu___is_Quote_static : quote_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Quote_static  -> true | uu____565 -> false
  
let (uu___is_Quote_dynamic : quote_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Quote_dynamic  -> true | uu____576 -> false
...
let (uu___is_NoUseRange : maybe_set_use_range -> Prims.bool) =
  fun projectee  ->
    match projectee with | NoUseRange  -> true | uu____592 -> false
  
let (uu___is_SomeUseRange : maybe_set_use_range -> Prims.bool) =
  fun projectee  ->
    match projectee with | SomeUseRange _0 -> true | uu____604 -> false
...
let (uu___is_Delta_abstract : delta_depth -> Prims.bool) =
  fun projectee  ->
    match projectee with | Delta_abstract _0 -> true | uu____689 -> false
...
let (uu___is_Allow_unresolved : should_check_uvar -> Prims.bool) =
  fun projectee  ->
    match projectee with | Allow_unresolved  -> true | uu____708 -> false
  
let (uu___is_Allow_untyped : should_check_uvar -> Prims.bool) =
  fun projectee  ->
    match projectee with | Allow_untyped  -> true | uu____719 -> false
  
let (uu___is_Strict : should_check_uvar -> Prims.bool) =
  fun projectee  ->
    match projectee with | Strict  -> true | uu____730 -> false
...
let (uu___is_Tm_uinst : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_uinst _0 -> true | uu____1689 -> false
...
let (uu___is_Tm_constant : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_constant _0 -> true | uu____1727 -> false
...
let (uu___is_Tm_type : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_type _0 -> true | uu____1747 -> false
...
let (uu___is_Tm_abs : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_abs _0 -> true | uu____1785 -> false
...
let (uu___is_Tm_arrow : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_arrow _0 -> true | uu____1873 -> false
...
let (uu___is_Tm_refine : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_refine _0 -> true | uu____1941 -> false
...
let (uu___is_Tm_app : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_app _0 -> true | uu____1995 -> false
...
let (uu___is_Tm_match : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_match _0 -> true | uu____2085 -> false
...
let (uu___is_Tm_ascribed : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_ascribed _0 -> true | uu____2197 -> false
...
let (uu___is_Tm_let : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_let _0 -> true | uu____2308 -> false
...
let (uu___is_Tm_uvar : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_uvar _0 -> true | uu____2379 -> false
...
let (uu___is_Tm_delayed : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_delayed _0 -> true | uu____2457 -> false
...
let (uu___is_Tm_meta : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_meta _0 -> true | uu____2549 -> false
...
let (uu___is_Tm_lazy : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_lazy _0 -> true | uu____2587 -> false
...
let (uu___is_Tm_quoted : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_quoted _0 -> true | uu____2613 -> false
...
let (uu___is_Tm_unknown : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_unknown  -> true | uu____2650 -> false
...
let (uu___is_Pat_constant : pat' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Pat_constant _0 -> true | uu____3084 -> false
  
let (__proj__Pat_constant__item___0 : pat' -> sconst) =
  fun projectee  -> match projectee with | Pat_constant _0 -> _0 
let (uu___is_Pat_cons : pat' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Pat_cons _0 -> true | uu____3117 -> false
...
let (uu___is_Pat_var : pat' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Pat_var _0 -> true | uu____3176 -> false
  
let (__proj__Pat_var__item___0 : pat' -> bv) =
  fun projectee  -> match projectee with | Pat_var _0 -> _0 
let (uu___is_Pat_wild : pat' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Pat_wild _0 -> true | uu____3196 -> false
  
let (__proj__Pat_wild__item___0 : pat' -> bv) =
  fun projectee  -> match projectee with | Pat_wild _0 -> _0 
let (uu___is_Pat_dot_term : pat' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Pat_dot_term _0 -> true | uu____3222 -> false
...
let (uu___is_Total : comp' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Total _0 -> true | uu____3686 -> false
...
let (uu___is_GTotal : comp' -> Prims.bool) =
  fun projectee  ->
    match projectee with | GTotal _0 -> true | uu____3738 -> false
...
let (uu___is_Comp : comp' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Comp _0 -> true | uu____3782 -> false
  
let (__proj__Comp__item___0 : comp' -> comp_typ) =
  fun projectee  -> match projectee with | Comp _0 -> _0 
let (uu___is_TOTAL : cflag -> Prims.bool) =
  fun projectee  ->
    match projectee with | TOTAL  -> true | uu____3801 -> false
  
let (uu___is_MLEFFECT : cflag -> Prims.bool) =
  fun projectee  ->
    match projectee with | MLEFFECT  -> true | uu____3812 -> false
  
let (uu___is_LEMMA : cflag -> Prims.bool) =
  fun projectee  ->
    match projectee with | LEMMA  -> true | uu____3823 -> false
  
let (uu___is_RETURN : cflag -> Prims.bool) =
  fun projectee  ->
    match projectee with | RETURN  -> true | uu____3834 -> false
  
let (uu___is_PARTIAL_RETURN : cflag -> Prims.bool) =
  fun projectee  ->
    match projectee with | PARTIAL_RETURN  -> true | uu____3845 -> false
  
let (uu___is_SOMETRIVIAL : cflag -> Prims.bool) =
  fun projectee  ->
    match projectee with | SOMETRIVIAL  -> true | uu____3856 -> false
...
let (uu___is_SHOULD_NOT_INLINE : cflag -> Prims.bool) =
  fun projectee  ->
    match projectee with | SHOULD_NOT_INLINE  -> true | uu____3878 -> false
  
let (uu___is_CPS : cflag -> Prims.bool) =
  fun projectee  -> match projectee with | CPS  -> true | uu____3889 -> false 
let (uu___is_DECREASES : cflag -> Prims.bool) =
  fun projectee  ->
    match projectee with | DECREASES _0 -> true | uu____3903 -> false
  
let (__proj__DECREASES__item___0 : cflag -> term' syntax) =
  fun projectee  -> match projectee with | DECREASES _0 -> _0 
let (uu___is_Meta_pattern : metadata -> Prims.bool) =
  fun projectee  ->
    match projectee with | Meta_pattern _0 -> true | uu____3941 -> false
...
let (uu___is_Meta_named : metadata -> Prims.bool) =
  fun projectee  ->
    match projectee with | Meta_named _0 -> true | uu____3997 -> false
...
let (uu___is_Meta_labeled : metadata -> Prims.bool) =
  fun projectee  ->
    match projectee with | Meta_labeled _0 -> true | uu____4025 -> false
...
let (uu___is_Meta_desugared : metadata -> Prims.bool) =
  fun projectee  ->
    match projectee with | Meta_desugared _0 -> true | uu____4069 -> false
...
let (uu___is_Meta_monadic : metadata -> Prims.bool) =
  fun projectee  ->
    match projectee with | Meta_monadic _0 -> true | uu____4095 -> false
...
let (uu___is_Meta_monadic_lift : metadata -> Prims.bool) =
  fun projectee  ->
    match projectee with | Meta_monadic_lift _0 -> true | uu____4141 -> false
...
let (uu___is_Sequence : meta_source_info -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sequence  -> true | uu____4184 -> false
  
let (uu___is_Primop : meta_source_info -> Prims.bool) =
  fun projectee  ->
    match projectee with | Primop  -> true | uu____4195 -> false
  
let (uu___is_Masked_effect : meta_source_info -> Prims.bool) =
  fun projectee  ->
    match projectee with | Masked_effect  -> true | uu____4206 -> false
  
let (uu___is_Meta_smt_pat : meta_source_info -> Prims.bool) =
  fun projectee  ->
    match projectee with | Meta_smt_pat  -> true | uu____4217 -> false
  
let (uu___is_Data_ctor : fv_qual -> Prims.bool) =
  fun projectee  ->
    match projectee with | Data_ctor  -> true | uu____4228 -> false
  
let (uu___is_Record_projector : fv_qual -> Prims.bool) =
  fun projectee  ->
    match projectee with | Record_projector _0 -> true | uu____4244 -> false
...
let (uu___is_Record_ctor : fv_qual -> Prims.bool) =
  fun projectee  ->
    match projectee with | Record_ctor _0 -> true | uu____4282 -> false
...
let (uu___is_DB : subst_elt -> Prims.bool) =
  fun projectee  ->
    match projectee with | DB _0 -> true | uu____4325 -> false
...
let (uu___is_NM : subst_elt -> Prims.bool) =
  fun projectee  ->
    match projectee with | NM _0 -> true | uu____4365 -> false
...
let (uu___is_NT : subst_elt -> Prims.bool) =
  fun projectee  ->
    match projectee with | NT _0 -> true | uu____4406 -> false
...
let (uu___is_UN : subst_elt -> Prims.bool) =
  fun projectee  ->
    match projectee with | UN _0 -> true | uu____4449 -> false
...
let (uu___is_UD : subst_elt -> Prims.bool) =
  fun projectee  ->
    match projectee with | UD _0 -> true | uu____4489 -> false
...
let (uu___is_BadLazy : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | BadLazy  -> true | uu____4894 -> false
  
let (uu___is_Lazy_bv : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_bv  -> true | uu____4905 -> false
  
let (uu___is_Lazy_binder : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_binder  -> true | uu____4916 -> false
  
let (uu___is_Lazy_fvar : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_fvar  -> true | uu____4927 -> false
  
let (uu___is_Lazy_comp : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_comp  -> true | uu____4938 -> false
  
let (uu___is_Lazy_env : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_env  -> true | uu____4949 -> false
  
let (uu___is_Lazy_proofstate : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_proofstate  -> true | uu____4960 -> false
  
let (uu___is_Lazy_goal : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_goal  -> true | uu____4971 -> false
  
let (uu___is_Lazy_sigelt : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_sigelt  -> true | uu____4982 -> false
  
let (uu___is_Lazy_uvar : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_uvar  -> true | uu____4993 -> false
  
let (uu___is_Lazy_embedding : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_embedding _0 -> true | uu____5013 -> false
...
let (uu___is_Binding_var : binding -> Prims.bool) =
  fun projectee  ->
    match projectee with | Binding_var _0 -> true | uu____5057 -> false
  
let (__proj__Binding_var__item___0 : binding -> bv) =
  fun projectee  -> match projectee with | Binding_var _0 -> _0 
let (uu___is_Binding_lid : binding -> Prims.bool) =
  fun projectee  ->
    match projectee with | Binding_lid _0 -> true | uu____5089 -> false
...
let (mk_lcomp :
  ...
  fun eff_name  ->
    fun res_typ  ->
      fun cflags  ->
        fun comp_thunk  ->
          let uu____5642 = FStar_Util.mk_ref (FStar_Util.Inl comp_thunk)  in
          { eff_name; res_typ; cflags; comp_thunk = uu____5642 }
  
let (lcomp_comp : lcomp -> comp) =
  fun lc  ->
    let uu____5690 = FStar_ST.op_Bang lc.comp_thunk  in
...
let (uu___is_Assumption : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Assumption  -> true | uu____5843 -> false
  
let (uu___is_New : qualifier -> Prims.bool) =
  fun projectee  -> match projectee with | New  -> true | uu____5854 -> false 
let (uu___is_Private : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Private  -> true | uu____5865 -> false
...
let (uu___is_Visible_default : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Visible_default  -> true | uu____5887 -> false
  
let (uu___is_Irreducible : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Irreducible  -> true | uu____5898 -> false
  
let (uu___is_Abstract : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Abstract  -> true | uu____5909 -> false
...
let (uu___is_NoExtract : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | NoExtract  -> true | uu____5931 -> false
  
let (uu___is_Noeq : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Noeq  -> true | uu____5942 -> false
  
let (uu___is_Unopteq : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Unopteq  -> true | uu____5953 -> false
  
let (uu___is_TotalEffect : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | TotalEffect  -> true | uu____5964 -> false
  
let (uu___is_Logic : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Logic  -> true | uu____5975 -> false
  
let (uu___is_Reifiable : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Reifiable  -> true | uu____5986 -> false
  
let (uu___is_Reflectable : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Reflectable _0 -> true | uu____5998 -> false
...
let (uu___is_Discriminator : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Discriminator _0 -> true | uu____6018 -> false
...
let (uu___is_Projector : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Projector _0 -> true | uu____6042 -> false
...
let (uu___is_RecordType : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | RecordType _0 -> true | uu____6082 -> false
...
let (uu___is_RecordConstructor : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | RecordConstructor _0 -> true | uu____6134 -> false
...
let (uu___is_Action : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Action _0 -> true | uu____6178 -> false
...
let (uu___is_HasMaskedEffect : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | HasMaskedEffect  -> true | uu____6208 -> false
  
let (uu___is_Effect : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Effect  -> true | uu____6219 -> false
  
let (uu___is_OnlyName : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | OnlyName  -> true | uu____6230 -> false
...
type term_monad = {
  ...
  monad_ret: tscheme ;
  monad_bind: tscheme }
let (__proj__Mkterm_monad__item__monad_m : term_monad -> term) =
  fun projectee  ->
    match projectee with | { monad_m; monad_ret; monad_bind;_} -> monad_m
  
let (__proj__Mkterm_monad__item__monad_ret : term_monad -> tscheme) =
  fun projectee  ->
    match projectee with | { monad_m; monad_ret; monad_bind;_} -> monad_ret
  
let (__proj__Mkterm_monad__item__monad_bind : term_monad -> tscheme) =
  fun projectee  ->
    match projectee with | { monad_m; monad_ret; monad_bind;_} -> monad_bind
...
type eff_decl =
  ...
  trivial: tscheme ;
  repr: term_monad ;
  elaborated: Prims.bool ;
  spec_dm4f: Prims.bool ;
  interp: tscheme FStar_Pervasives_Native.option ;
  mrelation: tscheme FStar_Pervasives_Native.option ;
...
let (__proj__Mkeff_decl__item__cattributes : eff_decl -> cflag Prims.list) =
  fun projectee  ->
    match projectee with
    | { cattributes; mname; univs; binders; spec; signature; if_then_else;
        ite_wp; stronger; close_wp; assert_p; assume_p; null_wp; trivial;
        repr; elaborated; spec_dm4f; interp; mrelation; actions; eff_attrs;_}
        -> cattributes
...
let (__proj__Mkeff_decl__item__spec : eff_decl -> term_monad) =
  fun projectee  ->
    match projectee with
    | { cattributes; mname; univs; binders; spec; signature; if_then_else;
        ite_wp; stronger; close_wp; assert_p; assume_p; null_wp; trivial;
...
let (__proj__Mkeff_decl__item__repr : eff_decl -> term_monad) =
  fun projectee  ->
    match projectee with
    | { cattributes; mname; univs; binders; spec; signature; if_then_else;
        ite_wp; stronger; close_wp; assert_p; assume_p; null_wp; trivial;
...
let (__proj__Mkeff_decl__item__elaborated : eff_decl -> Prims.bool) =
  fun projectee  ->
    match projectee with
    | { cattributes; mname; univs; binders; spec; signature; if_then_else;
        ite_wp; stronger; close_wp; assert_p; assume_p; null_wp; trivial;
...
let (__proj__Mkeff_decl__item__spec_dm4f : eff_decl -> Prims.bool) =
  fun projectee  ->
    match projectee with
    | { cattributes; mname; univs; binders; spec; signature; if_then_else;
        ite_wp; stronger; close_wp; assert_p; assume_p; null_wp; trivial;
...
let (__proj__Mkeff_decl__item__interp :
...
let (__proj__Mkeff_decl__item__mrelation :
  eff_decl -> tscheme FStar_Pervasives_Native.option) =
  fun projectee  ->
    match projectee with
    | { cattributes; mname; univs; binders; spec; signature; if_then_else;
...
let (uu___is_Sig_inductive_typ : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_inductive_typ _0 -> true | uu____7708 -> false
...
let (uu___is_Sig_bundle : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_bundle _0 -> true | uu____7784 -> false
...
let (uu___is_Sig_datacon : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_datacon _0 -> true | uu____7843 -> false
...
let (uu___is_Sig_declare_typ : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_declare_typ _0 -> true | uu____7914 -> false
...
let (uu___is_Sig_let : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_let _0 -> true | uu____7958 -> false
...
let (uu___is_Sig_main : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_main _0 -> true | uu____7996 -> false
...
let (uu___is_Sig_assume : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_assume _0 -> true | uu____8022 -> false
...
let (uu___is_Sig_new_effect : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_new_effect _0 -> true | uu____8060 -> false
...
let (uu___is_Sig_sub_effect : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_sub_effect _0 -> true | uu____8080 -> false
...
let (uu___is_Sig_effect_abbrev : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_effect_abbrev _0 -> true | uu____8112 -> false
...
let (uu___is_Sig_pragma : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_pragma _0 -> true | uu____8168 -> false
...
let (uu___is_Sig_splice : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_splice _0 -> true | uu____8194 -> false
...
let (contains_reflectable : qualifier Prims.list -> Prims.bool) =
  fun l  ->
    FStar_Util.for_some
      (fun uu___87_8417  ->
         match uu___87_8417 with
         | Reflectable uu____8419 -> true
         | uu____8421 -> false) l
...
let (set_range_of_bv : bv -> FStar_Range.range -> bv) =
  fun x  ->
    fun r  ->
      let uu___94_8539 = x  in
      let uu____8540 =
        FStar_Ident.mk_ident (((x.ppname).FStar_Ident.idText), r)  in
      {
        ppname = uu____8540;
        index = (uu___94_8539.index);
        sort = (uu___94_8539.sort)
      }
      ...
      let aq =
        FStar_List.map
          (fun uu____8577  ->
             ...
             | (bv,t) -> let uu____8588 = f t  in (bv, uu____8588))
          qi.antiquotes
         in
      let uu___95_8589 = qi  in
      { qkind = (uu___95_8589.qkind); antiquotes = aq }
  ...
  fun bv  ->
    fun aq  ->
      let uu____8605 =
        FStar_List.tryFind
          (fun uu____8623  ->
             match uu____8623 with | (bv',uu____8632) -> bv_eq bv bv') aq
         in
      match uu____8605 with
      | FStar_Pervasives_Native.Some (uu____8639,e) ->
          FStar_Pervasives_Native.Some e
      | FStar_Pervasives_Native.None  -> FStar_Pervasives_Native.None
  
let syn :
  'Auu____8670 'Auu____8671 'Auu____8672 .
    'Auu____8670 ->
      'Auu____8671 ->
        ('Auu____8671 -> 'Auu____8670 -> 'Auu____8672) -> 'Auu____8672
  = fun p  -> fun k  -> fun f  -> f k p 
let mk_fvs :
  'Auu____8714 .
    unit -> 'Auu____8714 FStar_Pervasives_Native.option FStar_ST.ref
  = fun uu____8723  -> FStar_Util.mk_ref FStar_Pervasives_Native.None 
let mk_uvs :
  'Auu____8742 .
    unit -> 'Auu____8742 FStar_Pervasives_Native.option FStar_ST.ref
  = fun uu____8751  -> FStar_Util.mk_ref FStar_Pervasives_Native.None 
let (new_bv_set : unit -> bv FStar_Util.set) =
  fun uu____8761  -> FStar_Util.new_set order_bv 
let (new_id_set : unit -> FStar_Ident.ident FStar_Util.set) =
  fun uu____8771  -> FStar_Util.new_set order_ident 
let (new_fv_set : unit -> FStar_Ident.lident FStar_Util.set) =
  fun uu____8781  -> FStar_Util.new_set order_fv 
let (order_univ_name : univ_name -> univ_name -> Prims.int) =
  fun x  ->
    fun y  ->
      let uu____8796 = FStar_Ident.text_of_id x  in
      let uu____8798 = FStar_Ident.text_of_id y  in
      FStar_String.compare uu____8796 uu____8798
  
let (new_universe_names_set : unit -> univ_name FStar_Util.set) =
  fun uu____8807  -> FStar_Util.new_set order_univ_name 
let (eq_binding : binding -> binding -> Prims.bool) =
  fun b1  ->
    fun b2  ->
      match (b1, b2) with
      | (Binding_var bv1,Binding_var bv2) -> bv_eq bv1 bv2
      | (Binding_lid (lid1,uu____8826),Binding_lid (lid2,uu____8828)) ->
...
let mk : 'a . 'a -> 'a mk_t_a =
  fun t  ->
    fun uu____8923  ->
      fun r  ->
        let uu____8927 = FStar_Util.mk_ref FStar_Pervasives_Native.None  in
        { n = t; pos = r; vars = uu____8927 }
  
let (bv_to_tm : bv -> term) =
  fun bv  ->
    let uu____8960 = range_of_bv bv  in
    mk (Tm_bvar bv) FStar_Pervasives_Native.None uu____8960
  
let (bv_to_name : bv -> term) =
  fun bv  ->
    let uu____8967 = range_of_bv bv  in
    mk (Tm_name bv) FStar_Pervasives_Native.None uu____8967
...
let (mk_Tm_uinst : term -> universes -> term) =
  fun t  ->
    fun uu___88_9022  ->
      match uu___88_9022 with
      | [] -> t
      | us ->
          (match t.n with
           | Tm_fvar uu____9024 ->
               mk (Tm_uinst (t, us)) FStar_Pervasives_Native.None t.pos
           | uu____9027 -> failwith "Unexpected universe instantiation")
    ...
    fun args'  ->
      fun kopt  ->
        fun r  ->
          ...
          | uu____9090 -> mk_Tm_app t args' kopt r
  ...
  fun lr  ->
    fun pos  ->
      let uu____9151 =
        let uu____9158 =
          let uu____9159 =
            let uu____9182 = FStar_Util.mk_ref FStar_Pervasives_Native.None
               in
            (lr, uu____9182)  in
          Tm_delayed uu____9159  in
        mk uu____9158  in
      uu____9151 FStar_Pervasives_Native.None pos
...
let (is_type : term -> Prims.bool) =
  fun t  -> match t.n with | Tm_type uu____9410 -> true | uu____9412 -> false 
...
let (mk_implicit_binder : bv -> binder) =
  fun a  -> (a, (FStar_Pervasives_Native.Some imp_tag)) 
let (null_binder : term -> binder) =
  fun t  ->
    let uu____9448 = null_bv t  in (uu____9448, FStar_Pervasives_Native.None)
...
let (is_top_level : letbinding Prims.list -> Prims.bool) =
  fun uu___89_9496  ->
    match uu___89_9496 with
    | { lbname = FStar_Util.Inr uu____9500; lbunivs = uu____9501;
        lbtyp = uu____9502; lbeff = uu____9503; lbdef = uu____9504;
        lbattrs = uu____9505; lbpos = uu____9506;_}::uu____9507 -> true
    | uu____9521 -> false
...
let (freenames_of_binders : binders -> freenames) =
  fun bs  ->
    FStar_List.fold_right
      (fun uu____9543  ->
         fun out  ->
           match uu____9543 with | (x,uu____9556) -> FStar_Util.set_add x out)
      bs no_names
...
let (binders_of_freenames : freenames -> binders) =
  fun fvs  ->
    let uu____9589 = FStar_Util.set_elements fvs  in
    FStar_All.pipe_right uu____9589 binders_of_list
  
let (is_implicit : aqual -> Prims.bool) =
  fun uu___90_9600  ->
    match uu___90_9600 with
    | FStar_Pervasives_Native.Some (Implicit uu____9602) -> true
    | uu____9605 -> false
...
let (pat_bvs : pat -> bv Prims.list) =
  fun p  ->
    let rec aux b p1 =
      match p1.v with
      | Pat_dot_term uu____9651 -> b
      | Pat_constant uu____9658 -> b
      | Pat_wild x -> x :: b
      | Pat_var x -> x :: b
      | Pat_cons (uu____9661,pats) ->
          FStar_List.fold_left
            (fun b1  ->
               fun uu____9695  ->
                 match uu____9695 with | (p2,uu____9708) -> aux b1 p2) b pats
       in
    let uu____9715 = aux [] p  in
    FStar_All.pipe_left FStar_List.rev uu____9715
  
let (gen_reset : ((unit -> Prims.int) * (unit -> unit))) =
  let x = FStar_Util.mk_ref (Prims.parse_int "0")  in
  let gen1 uu____9746 = FStar_Util.incr x; FStar_ST.op_Bang x  in
  let reset uu____9829 = FStar_ST.op_Colon_Equals x (Prims.parse_int "0")  in
  (gen1, reset) 
  ...
  fun s  ->
    fun r  ->
      fun t  ->
        ...
        let uu____9953 = next_id ()  in
        { ppname = id1; index = uu____9953; sort = t }
...
let (freshen_bv : bv -> bv) =
  fun bv  ->
    let uu____9976 = is_null_bv bv  in
    if uu____9976
    then
      let uu____9979 =
        let uu____9982 = range_of_bv bv  in
        FStar_Pervasives_Native.Some uu____9982  in
      new_bv uu____9979 bv.sort
    else
      (let uu___96_9985 = bv  in
       let uu____9986 = next_id ()  in
       {
         ppname = (uu___96_9985.ppname);
         index = uu____9986;
         sort = (uu___96_9985.sort)
       })
...
let (freshen_binder : binder -> binder) =
  fun b  ->
    ...
    | (bv,aq) -> let uu____10001 = freshen_bv bv  in (uu____10001, aq)
...
let (new_univ_name :
  ...
  fun ropt  ->
    ...
    let uu____10016 =
      let uu____10022 =
        let uu____10024 = FStar_Util.string_of_int id1  in
        Prims.strcat FStar_Ident.reserved_prefix uu____10024  in
      (uu____10022, (range_of_ropt ropt))  in
    FStar_Ident.mk_ident uu____10016
...
let (set_bv_range : bv -> FStar_Range.range -> bv) =
  fun bv  ->
    fun r  ->
      let uu___97_10155 = bv  in
      let uu____10156 =
        FStar_Ident.mk_ident (((bv.ppname).FStar_Ident.idText), r)  in
      {
        ppname = uu____10156;
        index = (uu___97_10155.index);
        sort = (uu___97_10155.sort)
      }
...
let (lid_as_fv :
  ...
  fun l  ->
    fun dd  ->
      fun dq  ->
        let uu____10178 =
          let uu____10179 = FStar_Ident.range_of_lid l  in
          withinfo l uu____10179  in
        { fv_name = uu____10178; fv_delta = dd; fv_qual = dq }
  
let (fv_to_tm : fv -> term) =
  fun fv  ->
    let uu____10186 = FStar_Ident.range_of_lid (fv.fv_name).v  in
    mk (Tm_fvar fv) FStar_Pervasives_Native.None uu____10186
...
let (fvar :
  ...
  fun l  ->
    fun dd  ->
      fun dq  -> let uu____10207 = lid_as_fv l dd dq  in fv_to_tm uu____10207
  
let (lid_of_fv : fv -> FStar_Ident.lid) = fun fv  -> (fv.fv_name).v 
let (range_of_fv : fv -> FStar_Range.range) =
  fun fv  ->
    let uu____10220 = lid_of_fv fv  in FStar_Ident.range_of_lid uu____10220
  
let (set_range_of_fv : fv -> FStar_Range.range -> fv) =
  fun fv  ->
    fun r  ->
      let uu___98_10232 = fv  in
      let uu____10233 =
        let uu___99_10234 = fv.fv_name  in
        let uu____10235 =
          let uu____10236 = lid_of_fv fv  in
          FStar_Ident.set_lid_range uu____10236 r  in
        { v = uu____10235; p = (uu___99_10234.p) }  in
      {
        fv_name = uu____10233;
        fv_delta = (uu___98_10232.fv_delta);
        fv_qual = (uu___98_10232.fv_qual)
      }
...
let (has_simple_attribute : term Prims.list -> Prims.string -> Prims.bool) =
  fun l  ->
    fun s  ->
      FStar_List.existsb
        (fun uu___93_10262  ->
           match uu___93_10262 with
           | { n = Tm_constant (FStar_Const.Const_string (data,uu____10267));
               pos = uu____10268; vars = uu____10269;_} when data = s -> true
           | uu____10276 -> false) l
  ...
  fun p1  ->
    fun p2  ->
      ...
      | (Pat_cons (fv1,as1),Pat_cons (fv2,as2)) ->
          let uu____10335 = fv_eq fv1 fv2  in
          if uu____10335
          then
            let uu____10340 = FStar_List.zip as1 as2  in
      ...
      | (Pat_var uu____10445,Pat_var uu____10446) -> true
      | (Pat_wild uu____10448,Pat_wild uu____10449) -> true
      | (Pat_dot_term (bv1,t1),Pat_dot_term (bv2,t2)) -> true
      | (uu____10464,uu____10465) -> false
...
let (tconst : FStar_Ident.lident -> term) =
  fun l  ->
    let uu____10483 =
      let uu____10490 = let uu____10491 = fvconst l  in Tm_fvar uu____10491
         in
      mk uu____10490  in
    uu____10483 FStar_Pervasives_Native.None FStar_Range.dummyRange
...
let (t_tactic_unit : term) =
  let uu____10538 =
    let uu____10543 =
      let uu____10544 = tabbrev FStar_Parser_Const.tactic_lid  in
      mk_Tm_uinst uu____10544 [U_zero]  in
    let uu____10545 = let uu____10546 = as_arg t_unit  in [uu____10546]  in
    mk_Tm_app uu____10543 uu____10545  in
  uu____10538 FStar_Pervasives_Native.None FStar_Range.dummyRange 
let (t_list_of : term -> term) =
  fun t  ->
    let uu____10579 =
      let uu____10584 =
        let uu____10585 = tabbrev FStar_Parser_Const.list_lid  in
        mk_Tm_uinst uu____10585 [U_zero]  in
      let uu____10586 = let uu____10587 = as_arg t  in [uu____10587]  in
      mk_Tm_app uu____10584 uu____10586  in
    uu____10579 FStar_Pervasives_Native.None FStar_Range.dummyRange
  
let (t_option_of : term -> term) =
  fun t  ->
    let uu____10620 =
      let uu____10625 =
        let uu____10626 = tabbrev FStar_Parser_Const.option_lid  in
        mk_Tm_uinst uu____10626 [U_zero]  in
      let uu____10627 = let uu____10628 = as_arg t  in [uu____10628]  in
      mk_Tm_app uu____10625 uu____10627  in
    uu____10620 FStar_Pervasives_Native.None FStar_Range.dummyRange
...
let (t_tuple2_of : term -> term -> term) =
  fun t1  ->
    fun t2  ->
      let uu____10666 =
        let uu____10671 =
          let uu____10672 = tabbrev FStar_Parser_Const.lid_tuple2  in
          mk_Tm_uinst uu____10672 [U_zero; U_zero]  in
        let uu____10673 =
          let uu____10674 = as_arg t1  in
          let uu____10683 = let uu____10694 = as_arg t2  in [uu____10694]  in
          uu____10674 :: uu____10683  in
        mk_Tm_app uu____10671 uu____10673  in
      uu____10666 FStar_Pervasives_Native.None FStar_Range.dummyRange
...
let (t_either_of : term -> term -> term) =
  fun t1  ->
    fun t2  ->
      let uu____10740 =
        let uu____10745 =
          let uu____10746 = tabbrev FStar_Parser_Const.either_lid  in
          mk_Tm_uinst uu____10746 [U_zero; U_zero]  in
        let uu____10747 =
          let uu____10748 = as_arg t1  in
          let uu____10757 = let uu____10768 = as_arg t2  in [uu____10768]  in
          uu____10748 :: uu____10757  in
        mk_Tm_app uu____10745 uu____10747  in
      uu____10740 FStar_Pervasives_Native.None FStar_Range.dummyRange
