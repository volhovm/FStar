    ...
    | FStar_Syntax_Syntax.Comp ct ->
        let effect_args =
          FStar_List.map
           ...
           in
        let ct1 =
          let uu___17_3031 = ct  in
          {
            FStar_Syntax_Syntax.comp_univs =
              (uu___17_3031.FStar_Syntax_Syntax.comp_univs);
            FStar_Syntax_Syntax.effect_name =
              (uu___17_3031.FStar_Syntax_Syntax.effect_name);
            FStar_Syntax_Syntax.result_typ =
              (uu___17_3031.FStar_Syntax_Syntax.result_typ);
            FStar_Syntax_Syntax.effect_args = effect_args;
            FStar_Syntax_Syntax.flags =
              (uu___17_3031.FStar_Syntax_Syntax.flags)
          }  in
        let c1 =
          let uu___18_3035 = c  in
          {
            FStar_Syntax_Syntax.n = (FStar_Syntax_Syntax.Comp ct1);
            FStar_Syntax_Syntax.pos = (uu___18_3035.FStar_Syntax_Syntax.pos);
            FStar_Syntax_Syntax.vars =
              (uu___18_3035.FStar_Syntax_Syntax.vars)
          }  in
        c1
                                         ...
                                         (let mk_tapp e ty_args =
                                            ...
                                            | uu____10975 ->
                                                let uu___21_10978 = e  in
                                                {
                                                  ...
                                                  FStar_Extraction_ML_Syntax.mlty
                                                    =
                                                    (uu___21_10978.FStar_Extraction_ML_Syntax.mlty);
                                                  FStar_Extraction_ML_Syntax.loc
                                                    =
                                                    (uu___21_10978.FStar_Extraction_ML_Syntax.loc)
                                                }
                                             in
                                          let head3 =
                                            ...
                                            | FStar_Extraction_ML_Syntax.MLE_Name
                                                   ...
                                                   in
                                                {
                                                  FStar_Extraction_ML_Syntax.expr
                                                    =
                                                    (uu___22_10983.FStar_Extraction_ML_Syntax.expr);
                                                  FStar_Extraction_ML_Syntax.mlty
                                                    = t2;
                                                  FStar_Extraction_ML_Syntax.loc
                                                    =
                                                    (uu___22_10983.FStar_Extraction_ML_Syntax.loc)
                                                }
                                            | FStar_Extraction_ML_Syntax.MLE_Var
                                                uu____10984 ->
                                                let uu___22_10986 =
                                                   ...
                                                   in
                                                {
                                                  FStar_Extraction_ML_Syntax.expr
                                                    =
                                                    (uu___22_10986.FStar_Extraction_ML_Syntax.expr);
                                                  FStar_Extraction_ML_Syntax.mlty
                                                    = t2;
                                                  FStar_Extraction_ML_Syntax.loc
                                                    =
                                                    (uu___22_10986.FStar_Extraction_ML_Syntax.loc)
                                                }
                                            | FStar_Extraction_ML_Syntax.MLE_App
                                                (head3,{
                                                         FStar_Extraction_ML_Syntax.expr
                                                  ...
                                                  (FStar_Extraction_ML_Syntax.MLE_App
                                                     ((let uu___23_10995 =
                                                          ...
                                                          in
                                                       {
                                                         FStar_Extraction_ML_Syntax.expr
                                                           =
                                                           (uu___23_10995.FStar_Extraction_ML_Syntax.expr);
                                                         FStar_Extraction_ML_Syntax.mlty
                                                           =
                                                           (FStar_Extraction_ML_Syntax.MLTY_Fun
                                                              (FStar_Extraction_ML_Syntax.ml_unit_ty,
                                                         ...
                                                         FStar_Extraction_ML_Syntax.loc
                                                           =
                                                           (uu___23_10995.FStar_Extraction_ML_Syntax.loc)
                                                       }),
                                                       [FStar_Extraction_ML_Syntax.ml_unit]))
                                                  (FStar_Extraction_ML_Syntax.with_ty
                                                     t2)
                                         ...
                                         (let mk_tapp e ty_args =
                                            ...
                                            | uu____11522 ->
                                                let uu___21_11525 = e  in
                                                {
                                                  ...
                                                  FStar_Extraction_ML_Syntax.mlty
                                                    =
                                                    (uu___21_11525.FStar_Extraction_ML_Syntax.mlty);
                                                  FStar_Extraction_ML_Syntax.loc
                                                    =
                                                    (uu___21_11525.FStar_Extraction_ML_Syntax.loc)
                                                }
                                             in
                                          let head3 =
                                            match head_ml.FStar_Extraction_ML_Syntax.expr
                                            ...
                                            | FStar_Extraction_ML_Syntax.MLE_Name
                                                   ...
                                                   in
                                                {
                                                  FStar_Extraction_ML_Syntax.expr
                                                    =
                                                    (uu___22_11530.FStar_Extraction_ML_Syntax.expr);
                                                  FStar_Extraction_ML_Syntax.mlty
                                                    = t2;
                                                  FStar_Extraction_ML_Syntax.loc
                                                    =
                                                    (uu___22_11530.FStar_Extraction_ML_Syntax.loc)
                                                }
                                            | FStar_Extraction_ML_Syntax.MLE_Var
                                                uu____11531 ->
                                                let uu___22_11533 =
                                                   ...
                                                   in
                                                {
                                                  FStar_Extraction_ML_Syntax.expr
                                                    =
                                                    (uu___22_11533.FStar_Extraction_ML_Syntax.expr);
                                                  FStar_Extraction_ML_Syntax.mlty
                                                    = t2;
                                                  FStar_Extraction_ML_Syntax.loc
                                                    =
                                                    (uu___22_11533.FStar_Extraction_ML_Syntax.loc)
                                                }
                                            | FStar_Extraction_ML_Syntax.MLE_App
                                                (head3,{
                                                         FStar_Extraction_ML_Syntax.expr
                                                  ...
                                                  (FStar_Extraction_ML_Syntax.MLE_App
                                                     ((let uu___23_11542 =
                                                          ...
                                                          in
                                                       {
                                                         FStar_Extraction_ML_Syntax.expr
                                                           =
                                                           (uu___23_11542.FStar_Extraction_ML_Syntax.expr);
                                                         FStar_Extraction_ML_Syntax.mlty
                                                           =
                                                           (FStar_Extraction_ML_Syntax.MLTY_Fun
                                                              (FStar_Extraction_ML_Syntax.ml_unit_ty,
                                                         ...
                                                         FStar_Extraction_ML_Syntax.loc
                                                           =
                                                           (uu___23_11542.FStar_Extraction_ML_Syntax.loc)
                                                       }),
                                                       [FStar_Extraction_ML_Syntax.ml_unit]))
                                                  (FStar_Extraction_ML_Syntax.with_ty
                                                     t2)
               ...
               (let uu____11792 = FStar_Syntax_Syntax.is_top_level lbs  in
                ...
                then (lbs, e')
                  ...
                  (let lb = FStar_List.hd lbs  in
                   ...
                   let lb1 =
                     let uu___24_11809 = lb  in
                     {
                       FStar_Syntax_Syntax.lbname = (FStar_Util.Inl x);
                       FStar_Syntax_Syntax.lbunivs =
                         (uu___24_11809.FStar_Syntax_Syntax.lbunivs);
                       FStar_Syntax_Syntax.lbtyp =
                         (uu___24_11809.FStar_Syntax_Syntax.lbtyp);
                       FStar_Syntax_Syntax.lbeff =
                         (uu___24_11809.FStar_Syntax_Syntax.lbeff);
                       FStar_Syntax_Syntax.lbdef =
                         (uu___24_11809.FStar_Syntax_Syntax.lbdef);
                       FStar_Syntax_Syntax.lbattrs =
                         (uu___24_11809.FStar_Syntax_Syntax.lbattrs);
                       FStar_Syntax_Syntax.lbpos =
                         (uu___24_11809.FStar_Syntax_Syntax.lbpos)
                     }  in
                   let e'1 =
                         ...
                         (fun lb  ->
                            ...
                            let lbdef =
                              ...
                              then lb.FStar_Syntax_Syntax.lbdef
                               ...
                               in
                            let uu___25_11902 = lb  in
                            {
                              FStar_Syntax_Syntax.lbname =
                                (uu___25_11902.FStar_Syntax_Syntax.lbname);
                              FStar_Syntax_Syntax.lbunivs =
                                (uu___25_11902.FStar_Syntax_Syntax.lbunivs);
                              FStar_Syntax_Syntax.lbtyp =
                                (uu___25_11902.FStar_Syntax_Syntax.lbtyp);
                              FStar_Syntax_Syntax.lbeff =
                                (uu___25_11902.FStar_Syntax_Syntax.lbeff);
                              FStar_Syntax_Syntax.lbdef = lbdef;
                              FStar_Syntax_Syntax.lbattrs =
                                (uu___25_11902.FStar_Syntax_Syntax.lbattrs);
                              FStar_Syntax_Syntax.lbpos =
                                (uu___25_11902.FStar_Syntax_Syntax.lbpos)
                            }))
                  else lbs1  in
