...
let (load_parsing_data_from_cache :
  ...
  fun file_name  ->
    let cache_file =
      ...
      with | uu___21_1401 -> FStar_Pervasives_Native.None  in
        ...
        fun tc_result  ->
          ...
          then
            ...
            | FStar_Pervasives_Native.Some hashes ->
                let tc_result1 =
                  let uu___23_2174 = tc_result  in
                  {
                    checked_module = (uu___23_2174.checked_module);
                    mii = (uu___23_2174.mii);
                    smt_decls = (uu___23_2174.smt_decls);
                    tc_time = (Prims.parse_int "0");
                    extraction_time = (uu___23_2174.extraction_time)
                  }  in
                let uu____2176 =
...
let rec (tc_fold_interleave :
  ...
  fun deps  ->
    fun acc  ->
      fun remaining  ->
        let as_list uu___12_3694 =
          match uu___12_3694 with
          | FStar_Pervasives_Native.None  -> []
