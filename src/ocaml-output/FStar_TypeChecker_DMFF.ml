            ...
            let a1 =
                 ...
                 in
              {
                FStar_Syntax_Syntax.ppname =
                  (uu___33_127.FStar_Syntax_Syntax.ppname);
                FStar_Syntax_Syntax.index =
                  (uu___33_127.FStar_Syntax_Syntax.index);
                        ...
                        let t2 =
                            ...
                            FStar_Syntax_Syntax.Tm_arrow uu____3166  in
                          {
                            ...
                            FStar_Syntax_Syntax.pos =
                              (uu___34_3164.FStar_Syntax_Syntax.pos);
                            FStar_Syntax_Syntax.vars =
                              (uu___34_3164.FStar_Syntax_Syntax.vars)
                          }  in
                        mk_rel1 t2 x y
                    ...
                    let uu____4261 =
                         ...
                         in
                      {
                        FStar_Syntax_Syntax.cattributes =
                          (uu___35_4262.FStar_Syntax_Syntax.cattributes);
                        FStar_Syntax_Syntax.mname =
                          (uu___35_4262.FStar_Syntax_Syntax.mname);
                        FStar_Syntax_Syntax.univs =
                          (uu___35_4262.FStar_Syntax_Syntax.univs);
                        FStar_Syntax_Syntax.binders =
                          (uu___35_4262.FStar_Syntax_Syntax.binders);
                        FStar_Syntax_Syntax.signature =
                          (uu___35_4262.FStar_Syntax_Syntax.signature);
                        FStar_Syntax_Syntax.ret_wp =
                          (uu___35_4262.FStar_Syntax_Syntax.ret_wp);
                        FStar_Syntax_Syntax.bind_wp =
                          (uu___35_4262.FStar_Syntax_Syntax.bind_wp);
                        ...
                        FStar_Syntax_Syntax.repr =
                          (uu___35_4262.FStar_Syntax_Syntax.repr);
                        FStar_Syntax_Syntax.return_repr =
                          (uu___35_4262.FStar_Syntax_Syntax.return_repr);
                        FStar_Syntax_Syntax.bind_repr =
                          (uu___35_4262.FStar_Syntax_Syntax.bind_repr);
                        FStar_Syntax_Syntax.actions =
                          (uu___35_4262.FStar_Syntax_Syntax.actions);
                        FStar_Syntax_Syntax.eff_attrs =
                          (uu___35_4262.FStar_Syntax_Syntax.eff_attrs)
                      }  in
...
let (set_env : env -> FStar_TypeChecker_Env.env -> env) =
  fun dmff_env  ->
    fun env'  ->
      let uu___36_4344 = dmff_env  in
      {
        tcenv = env';
        subst = (uu___36_4344.subst);
        tc_const = (uu___36_4344.tc_const)
      }
    ...
    fun t  ->
          ...
          let binders1 =
            FStar_List.map
              (fun uu____4744  ->
                 ...
                 | (bv,aqual) ->
                     let uu____4763 =
                       let uu___37_4764 = bv  in
                       let uu____4765 =
                         star_type' env bv.FStar_Syntax_Syntax.sort  in
                       {
                         FStar_Syntax_Syntax.ppname =
                           (uu___37_4764.FStar_Syntax_Syntax.ppname);
                         FStar_Syntax_Syntax.index =
                           (uu___37_4764.FStar_Syntax_Syntax.index);
      ...
      | FStar_Syntax_Syntax.Tm_abs (binders,repr,something) ->
          ...
          (match uu____5473 with
           | (binders1,repr1) ->
               let env1 =
                 let uu___40_5481 = env  in
                 let uu____5482 =
                   FStar_TypeChecker_Env.push_binders env.tcenv binders1  in
                 {
                   tcenv = uu____5482;
                   subst = (uu___40_5481.subst);
                   tc_const = (uu___40_5481.tc_const)
                 }  in
      ...
      | FStar_Syntax_Syntax.Tm_refine (x,t2) when false ->
          ...
          mk1
            (FStar_Syntax_Syntax.Tm_refine
               ((let uu___41_5509 = x1  in
                 {
                   FStar_Syntax_Syntax.ppname =
                     (uu___41_5509.FStar_Syntax_Syntax.ppname);
                   FStar_Syntax_Syntax.index =
                     (uu___41_5509.FStar_Syntax_Syntax.index);
...
let (is_monadic :
  ...
  =
  fun uu___25_6087  ->
    match uu___25_6087 with
    | FStar_Pervasives_Native.None  -> failwith "un-annotated lambda?!"
    | FStar_Pervasives_Native.Some rc ->
        FStar_All.pipe_right rc.FStar_Syntax_Syntax.residual_flags
          (FStar_Util.for_some
             (fun uu___24_6098  ->
                match uu___24_6098 with
                | FStar_Syntax_Syntax.CPS  -> true
                | uu____6101 -> false))
    ...
    fun e  ->
      fun context_nm  ->
        ...
        let ensure_m env1 e2 =
          let strip_m uu___27_6860 =
            match uu___27_6860 with
  ...
  fun env  ->
    fun e  ->
      ...
      | FStar_Syntax_Syntax.Tm_abs (binders,body,rc_opt) ->
                ...
                let uu____7386 =
                    ...
                    FStar_Pervasives_Native.Some uu____7393  in
                  {
                    FStar_Syntax_Syntax.residual_effect =
                      (uu___42_7387.FStar_Syntax_Syntax.residual_effect);
                    FStar_Syntax_Syntax.residual_typ = uu____7388;
                    FStar_Syntax_Syntax.residual_flags =
                      (uu___42_7387.FStar_Syntax_Syntax.residual_flags)
                  }  in
          ...
          let env1 =
            let uu___43_7408 = env  in
            let uu____7409 =
              FStar_TypeChecker_Env.push_binders env.tcenv binders1  in
            {
              tcenv = uu____7409;
              subst = (uu___43_7408.subst);
              tc_const = (uu___43_7408.tc_const)
            }  in
          let s_binders =
            FStar_List.map
              (fun uu____7435  ->
                 ...
                 | (bv,qual) ->
                     let sort = star_type' env1 bv.FStar_Syntax_Syntax.sort
                        in
                     ((let uu___44_7458 = bv  in
                       {
                         FStar_Syntax_Syntax.ppname =
                           (uu___44_7458.FStar_Syntax_Syntax.ppname);
                         FStar_Syntax_Syntax.index =
                           (uu___44_7458.FStar_Syntax_Syntax.index);
                         FStar_Syntax_Syntax.sort = sort
                       }), qual)) binders1
             in
          let uu____7459 =
                   ...
                   | ((env2,acc),(bv,qual)) ->
                       ...
                       then
                         ...
                         let x =
                           ...
                           {
                             FStar_Syntax_Syntax.ppname =
                               (uu___45_7562.FStar_Syntax_Syntax.ppname);
                             FStar_Syntax_Syntax.index =
                               (uu___45_7562.FStar_Syntax_Syntax.index);
                             FStar_Syntax_Syntax.sort = uu____7563
                           }  in
                         let env3 =
                           let uu___46_7568 = env2  in
                           let uu____7569 =
                             let uu____7572 =
                               let uu____7573 =
                                 let uu____7580 =
                           ...
                           {
                             tcenv = (uu___46_7568.tcenv);
                             subst = uu____7569;
                             tc_const = (uu___46_7568.tc_const)
                           }  in
                         let uu____7585 =
                         ...
                         (let x =
                            let uu___47_7598 = bv  in
                            let uu____7599 =
                              star_type' env2 bv.FStar_Syntax_Syntax.sort  in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___47_7598.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___47_7598.FStar_Syntax_Syntax.index);
                           ...
                           | FStar_Pervasives_Native.Some rt ->
                               ...
                               then
                                 ...
                                 (let uu____7798 =
                                    ...
                                    {
                                      FStar_Syntax_Syntax.residual_effect =
                                        (uu___48_7799.FStar_Syntax_Syntax.residual_effect);
                                      FStar_Syntax_Syntax.residual_typ =
                                        uu____7800;
                                      FStar_Syntax_Syntax.residual_flags =
                                        (uu___48_7799.FStar_Syntax_Syntax.residual_flags)
                                    }  in
                    ...
                    (fun b  ->
                       ...
                       | (pat,FStar_Pervasives_Native.None ,body) ->
                           let env1 =
                             ...
                             {
                               tcenv = uu____10754;
                               subst = (uu___49_10753.subst);
                               tc_const = (uu___49_10753.tc_const)
                             }  in
          ...
          fun ensure_m  ->
            ...
            | (x_binders1,e21) ->
                ...
                (match uu____12170 with
                       ...
                       then
                           ...
                           trans_F_ env t1 uu____12194  in
                         {
                           FStar_Syntax_Syntax.lbname =
                             (uu___50_12190.FStar_Syntax_Syntax.lbname);
                           FStar_Syntax_Syntax.lbunivs =
                             (uu___50_12190.FStar_Syntax_Syntax.lbunivs);
                           FStar_Syntax_Syntax.lbtyp = uu____12191;
                           FStar_Syntax_Syntax.lbeff =
                             (uu___50_12190.FStar_Syntax_Syntax.lbeff);
                           FStar_Syntax_Syntax.lbdef =
                             (uu___50_12190.FStar_Syntax_Syntax.lbdef);
                           FStar_Syntax_Syntax.lbattrs =
                             (uu___50_12190.FStar_Syntax_Syntax.lbattrs);
                           FStar_Syntax_Syntax.lbpos =
                             (uu___50_12190.FStar_Syntax_Syntax.lbpos)
                         }
                       else binding  in
                     let env1 =
                       let uu___51_12198 = env  in
                       let uu____12199 =
                         FStar_TypeChecker_Env.push_bv env.tcenv
                           (let uu___52_12201 = x  in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___52_12201.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___52_12201.FStar_Syntax_Syntax.index);
                              FStar_Syntax_Syntax.sort = t1
                            })
                          in
                       {
                         tcenv = uu____12199;
                         subst = (uu___51_12198.subst);
                         tc_const = (uu___51_12198.tc_const)
                       }  in
                     let uu____12202 = proceed env1 e21  in
                     (match uu____12202 with
                      | (nm_rec,s_e2,u_e2) ->
                          let s_binding =
                            let uu___53_12219 = binding  in
                            let uu____12220 =
                              star_type' env1
                            ...
                            {
                              FStar_Syntax_Syntax.lbname =
                                (uu___53_12219.FStar_Syntax_Syntax.lbname);
                              FStar_Syntax_Syntax.lbunivs =
                                (uu___53_12219.FStar_Syntax_Syntax.lbunivs);
                              FStar_Syntax_Syntax.lbtyp = uu____12220;
                              FStar_Syntax_Syntax.lbeff =
                                (uu___53_12219.FStar_Syntax_Syntax.lbeff);
                              FStar_Syntax_Syntax.lbdef =
                                (uu___53_12219.FStar_Syntax_Syntax.lbdef);
                              FStar_Syntax_Syntax.lbattrs =
                                (uu___53_12219.FStar_Syntax_Syntax.lbattrs);
                              FStar_Syntax_Syntax.lbpos =
                                (uu___53_12219.FStar_Syntax_Syntax.lbpos)
                            }  in
                          let uu____12223 =
                            let uu____12224 =
                              let uu____12225 =
                                let uu____12239 =
                                  FStar_Syntax_Subst.close x_binders1 s_e2
                                   in
                                ((false,
                                   [(let uu___54_12256 = s_binding  in
                                     {
                                       FStar_Syntax_Syntax.lbname =
                                         (uu___54_12256.FStar_Syntax_Syntax.lbname);
                                       FStar_Syntax_Syntax.lbunivs =
                                         (uu___54_12256.FStar_Syntax_Syntax.lbunivs);
                                       FStar_Syntax_Syntax.lbtyp =
                                         (uu___54_12256.FStar_Syntax_Syntax.lbtyp);
                                       FStar_Syntax_Syntax.lbeff =
                                         (uu___54_12256.FStar_Syntax_Syntax.lbeff);
                                       FStar_Syntax_Syntax.lbdef = s_e1;
                                       FStar_Syntax_Syntax.lbattrs =
                                         (uu___54_12256.FStar_Syntax_Syntax.lbattrs);
                                       FStar_Syntax_Syntax.lbpos =
                                         (uu___54_12256.FStar_Syntax_Syntax.lbpos)
                                     })]), uu____12239)
                                 in
                              ...
                              let uu____12259 =
                                let uu____12273 =
                                  FStar_Syntax_Subst.close x_binders1 u_e2
                                   in
                                ((false,
                                   [(let uu___55_12290 = u_binding  in
                                     {
                                       FStar_Syntax_Syntax.lbname =
                                         (uu___55_12290.FStar_Syntax_Syntax.lbname);
                                       FStar_Syntax_Syntax.lbunivs =
                                         (uu___55_12290.FStar_Syntax_Syntax.lbunivs);
                                       FStar_Syntax_Syntax.lbtyp =
                                         (uu___55_12290.FStar_Syntax_Syntax.lbtyp);
                                       FStar_Syntax_Syntax.lbeff =
                                         (uu___55_12290.FStar_Syntax_Syntax.lbeff);
                                       FStar_Syntax_Syntax.lbdef = u_e1;
                                       FStar_Syntax_Syntax.lbattrs =
                                         (uu___55_12290.FStar_Syntax_Syntax.lbattrs);
                                       FStar_Syntax_Syntax.lbpos =
                                         (uu___55_12290.FStar_Syntax_Syntax.lbpos)
                                     })]), uu____12273)
                                 in
                 ...
                 | (M t1,s_e1,u_e1) ->
                     let u_binding =
                       let uu___56_12295 = binding  in
                       {
                         FStar_Syntax_Syntax.lbname =
                           (uu___56_12295.FStar_Syntax_Syntax.lbname);
                         FStar_Syntax_Syntax.lbunivs =
                           (uu___56_12295.FStar_Syntax_Syntax.lbunivs);
                         FStar_Syntax_Syntax.lbtyp = t1;
                         FStar_Syntax_Syntax.lbeff =
                           FStar_Parser_Const.effect_PURE_lid;
                         FStar_Syntax_Syntax.lbdef =
                           (uu___56_12295.FStar_Syntax_Syntax.lbdef);
                         FStar_Syntax_Syntax.lbattrs =
                           (uu___56_12295.FStar_Syntax_Syntax.lbattrs);
                         FStar_Syntax_Syntax.lbpos =
                           (uu___56_12295.FStar_Syntax_Syntax.lbpos)
                       }  in
                     let env1 =
                       let uu___57_12297 = env  in
                       let uu____12298 =
                         FStar_TypeChecker_Env.push_bv env.tcenv
                           (let uu___58_12300 = x  in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___58_12300.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___58_12300.FStar_Syntax_Syntax.index);
                              FStar_Syntax_Syntax.sort = t1
                            })
                          in
                       {
                         tcenv = uu____12298;
                         subst = (uu___57_12297.subst);
                         tc_const = (uu___57_12297.tc_const)
                       }  in
                              ...
                              let uu____12505 =
                                let uu____12519 =
                                  FStar_Syntax_Subst.close x_binders1 u_e2
                                   in
                                ((false,
                                   [(let uu___59_12536 = u_binding  in
                                     {
                                       FStar_Syntax_Syntax.lbname =
                                         (uu___59_12536.FStar_Syntax_Syntax.lbname);
                                       FStar_Syntax_Syntax.lbunivs =
                                         (uu___59_12536.FStar_Syntax_Syntax.lbunivs);
                                       FStar_Syntax_Syntax.lbtyp =
                                         (uu___59_12536.FStar_Syntax_Syntax.lbtyp);
                                       FStar_Syntax_Syntax.lbeff =
                                         (uu___59_12536.FStar_Syntax_Syntax.lbeff);
                                       FStar_Syntax_Syntax.lbdef = u_e1;
                                       FStar_Syntax_Syntax.lbattrs =
                                         (uu___59_12536.FStar_Syntax_Syntax.lbattrs);
                                       FStar_Syntax_Syntax.lbpos =
                                         (uu___59_12536.FStar_Syntax_Syntax.lbpos)
                                     })]), uu____12519)
                                 in
