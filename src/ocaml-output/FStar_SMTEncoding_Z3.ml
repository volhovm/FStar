...
let (parse_z3_version_lines :
  ...
  fun out  ->
    ...
    | x::uu____38 ->
        ...
        let rec aux uu___16_62 =
          match uu___16_62 with
          | hash::[] ->
              let n1 =
...
let (z3hash_warning_message :
  ...
  fun uu____130  ->
    let run_proc_result =
      ...
      with | uu___21_155 -> FStar_Pervasives_Native.None  in
