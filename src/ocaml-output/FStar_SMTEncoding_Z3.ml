...
let (bg_z3_proc : bgproc FStar_ST.ref) =
  ...
  let refresh uu____2438 =
    (let uu____2440 = FStar_Options.debug_any ()  in
     if uu____2440
     then FStar_Errors.diag FStar_Range.dummyRange "Restarting SMT solver..."
     else ());
    (let uu____2447 = z3proc ()  in FStar_Util.kill_process uu____2447);
    (let uu____2449 =
       let uu____2452 = new_z3proc_with_id ()  in
       FStar_Pervasives_Native.Some uu____2452  in
     FStar_ST.op_Colon_Equals the_z3proc uu____2449);
    query_logging.close_log ()  in
  let restart uu____2503 =
    query_logging.close_log ();
    FStar_ST.op_Colon_Equals the_z3proc FStar_Pervasives_Native.None;
    (let uu____2551 =
       let uu____2554 = new_z3proc_with_id ()  in
       FStar_Pervasives_Native.Some uu____2554  in
     FStar_ST.op_Colon_Equals the_z3proc uu____2551)
     in
  FStar_Util.mk_ref
    {
    ...
    fun r  ->
      fun lines  ->
        let rec until tag lines1 =
          ...
          | l::lines2 ->
              ...
              then FStar_Pervasives_Native.Some ([], lines2)
                ...
                (let uu____2902 = until tag lines2  in
                 FStar_Util.map_opt uu____2902
                   (fun uu____2938  ->
        ...
        let find_section tag lines1 =
          let uu____3045 = until (start_tag tag) lines1  in
          match uu____3045 with
          | FStar_Pervasives_Native.None  ->
              (FStar_Pervasives_Native.None, lines1)
          | FStar_Pervasives_Native.Some (prefix1,suffix) ->
              let uu____3115 = until (end_tag tag) suffix  in
           ...
           in
        let uu____3200 = find_section "result" lines  in
        match uu____3200 with
        | (result_opt,lines1) ->
            let result = FStar_Util.must result_opt  in
            let uu____3239 = find_section "reason-unknown" lines1  in
            (match uu____3239 with
             | (reason_unknown,lines2) ->
                 let uu____3271 = find_section "unsat-core" lines2  in
                 (match uu____3271 with
                  | (unsat_core,lines3) ->
                      let uu____3303 = find_section "statistics" lines3  in
                      (match uu____3303 with
                       | (statistics,lines4) ->
                           let uu____3335 = find_section "labels" lines4  in
                           (match uu____3335 with
                            | (labels,lines5) ->
                                let remaining =
                                  let uu____3371 = until "Done!" lines5  in
                                  ...
                                  | uu____3425 ->
                                      ...
                                      FStar_Errors.log_issue r
                                        (FStar_Errors.Warning_UnexpectedZ3Output,
                                          msg));
                                 (let uu____3441 = FStar_Util.must result_opt
                                     in
                                  {
                                    smt_result = uu____3441;
            ...
            let parse z3out =
                ...
                | FStar_Pervasives_Native.Some lines1 ->
                    let rec lblnegs lines2 =
                      ...
                      | lname::"false"::rest when
                          ...
                          let uu____3581 = lblnegs rest  in lname ::
                            uu____3581
                      | lname::uu____3587::rest when
                          FStar_Util.starts_with lname "label_" ->
                          lblnegs rest
                      | uu____3597 -> []  in
              ...
              let status =
                 ...
                 then
                   let uu____3840 =
                     FStar_Util.format1 "Z3 says: %s\n"
                      ...
                      in
                   FStar_All.pipe_left FStar_Util.print_string uu____3840
                 else ());
                (match smt_output.smt_result with
                 ...
                 | "killed"::[] ->
                     ((let uu____3872 =
                         let uu____3877 = FStar_ST.op_Bang bg_z3_proc  in
                         uu____3877.restart  in
                       uu____3872 ());
                      KILLED)
                 | uu____3897 ->
                     let uu____3898 =
            ...
            fun qhash  ->
              fun uu____4287  ->
                ...
                let uu____4297 =
                  ...
                  | uu___131_4314 ->
                      if
                        let uu____4319 = FStar_Options.trace_error ()  in
                        Prims.op_Negation uu____4319
                      then
                        Obj.magic
                          (Obj.repr
                             ((let uu____4322 =
                                 let uu____4327 = FStar_ST.op_Bang bg_z3_proc
                                    in
                                 uu____4327.refresh  in
                               uu____4322 ());
                              FStar_Exn.raise uu___131_4314))
                      else Obj.magic (Obj.repr (failwith "unreachable"))
                   in
                match uu____4297 with
                | (status,statistics) ->
                    let uu____4353 =
                      let uu____4359 = FStar_Util.now ()  in
                      FStar_Util.time_diff start uu____4359  in
                    (match uu____4353 with
                     | (uu____4360,elapsed_time) ->
                         {
...
let rec (dequeue' : unit -> unit) =
  fun uu____4394  ->
    let j =
      let uu____4396 = FStar_ST.op_Bang job_queue  in
    ...
    FStar_Util.with_monitor job_queue
      (fun uu____4464  -> FStar_Util.decr pending_jobs) ();
    dequeue ()

and (dequeue : unit -> unit) =
  fun uu____4466  ->
    let uu____4467 = FStar_ST.op_Bang running  in
    if uu____4467
    then
      let rec aux uu____4495 =
        FStar_Util.monitor_enter job_queue;
        (let uu____4501 = FStar_ST.op_Bang job_queue  in
...
and (run_job : z3job -> unit) =
  fun j  ->
    let uu____4538 = j.job ()  in FStar_All.pipe_left j.callback uu____4538
...
let (enqueue : z3job -> unit) =
  fun j  ->
    FStar_Util.with_monitor job_queue
      (fun uu____4601  ->
         (let uu____4603 =
            let uu____4606 = FStar_ST.op_Bang job_queue  in
            FStar_List.append uu____4606 [j]  in
          FStar_ST.op_Colon_Equals job_queue uu____4603);
         FStar_Util.monitor_pulse job_queue) ()
  
let (finish : unit -> unit) =
  fun uu____4664  ->
    let rec aux uu____4670 =
      let uu____4671 =
        FStar_Util.with_monitor job_queue
          (fun uu____4689  ->
             let uu____4690 = FStar_ST.op_Bang pending_jobs  in
             let uu____4713 =
               let uu____4714 = FStar_ST.op_Bang job_queue  in
               FStar_List.length uu____4714  in
             (uu____4690, uu____4713)) ()
         in
...
let (mk_fresh_scope : unit -> scope_t) =
  fun uu____4809  -> FStar_ST.op_Bang fresh_scope 
let (flatten_fresh_scope : unit -> FStar_SMTEncoding_Term.decl Prims.list) =
  fun uu____4836  ->
    let uu____4837 =
      let uu____4842 = FStar_ST.op_Bang fresh_scope  in
      FStar_List.rev uu____4842  in
    FStar_List.flatten uu____4837
...
let (push : Prims.string -> unit) =
  fun msg  ->
    FStar_Util.atomically
      (fun uu____4897  ->
         (let uu____4899 =
            let uu____4900 = FStar_ST.op_Bang fresh_scope  in
            [FStar_SMTEncoding_Term.Caption msg; FStar_SMTEncoding_Term.Push]
              :: uu____4900
             in
          FStar_ST.op_Colon_Equals fresh_scope uu____4899);
         (let uu____4945 =
            let uu____4948 = FStar_ST.op_Bang bg_scope  in
            FStar_List.append uu____4948
              [FStar_SMTEncoding_Term.Push;
              FStar_SMTEncoding_Term.Caption msg]
             in
          FStar_ST.op_Colon_Equals bg_scope uu____4945))
...
let (pop : Prims.string -> unit) =
  fun msg  ->
    FStar_Util.atomically
      (fun uu____5008  ->
         (let uu____5010 =
            let uu____5011 = FStar_ST.op_Bang fresh_scope  in
            FStar_List.tl uu____5011  in
          FStar_ST.op_Colon_Equals fresh_scope uu____5010);
         (let uu____5056 =
            let uu____5059 = FStar_ST.op_Bang bg_scope  in
            FStar_List.append uu____5059
              [FStar_SMTEncoding_Term.Caption msg;
              FStar_SMTEncoding_Term.Pop]
             in
          FStar_ST.op_Colon_Equals bg_scope uu____5056))
...
let (rollback :
  ...
  fun msg  ->
    fun depth  ->
      FStar_Common.rollback (fun uu____5146  -> pop msg) fresh_scope depth
...
let (giveZ3 : FStar_SMTEncoding_Term.decl Prims.list -> unit) =
  fun decls  ->
    FStar_All.pipe_right decls
      (FStar_List.iter
         (fun uu___126_5161  ->
            match uu___126_5161 with
            | FStar_SMTEncoding_Term.Push  -> failwith "Unexpected push/pop"
            | FStar_SMTEncoding_Term.Pop  -> failwith "Unexpected push/pop"
            | uu____5164 -> ()));
    (let uu____5166 = FStar_ST.op_Bang fresh_scope  in
     match uu____5166 with
     | hd1::tl1 ->
         FStar_ST.op_Colon_Equals fresh_scope ((FStar_List.append hd1 decls)
           :: tl1)
     | uu____5217 -> failwith "Impossible");
    (let uu____5219 =
       let uu____5222 = FStar_ST.op_Bang bg_scope  in
       FStar_List.append uu____5222 decls  in
     FStar_ST.op_Colon_Equals bg_scope uu____5219)
  
let (refresh : unit -> unit) =
  fun uu____5276  ->
    (let uu____5278 =
       let uu____5280 = FStar_Options.n_cores ()  in
       uu____5280 < (Prims.parse_int "2")  in
     if uu____5278
     then
       let uu____5284 =
         let uu____5289 = FStar_ST.op_Bang bg_z3_proc  in uu____5289.refresh
          in
       uu____5284 ()
     else ());
    (let uu____5311 = flatten_fresh_scope ()  in
     FStar_ST.op_Colon_Equals bg_scope uu____5311)
                 ...
                 (match d with
                  | FStar_SMTEncoding_Term.Module (name,decls) ->
                      let decls1 =
                        FStar_List.filter
                          (fun uu___127_5445  ->
                             match uu___127_5445 with
                             | FStar_SMTEncoding_Term.Assume uu____5447 ->
                                 true
                             | uu____5449 -> false) decls
                         in
                      let n1 = FStar_List.length decls1  in
                      (((name, n1) :: out), (n1 + _total))
                  | uu____5476 -> (out, _total))) ([], (Prims.parse_int "0"))
        theory
       in
          ...
          FStar_List.sortWith
            (fun uu____5538  ->
               fun uu____5539  ->
                 ...
                 | ((uu____5565,n1),(uu____5567,m)) -> m - n1) modules
           in
        (if modules1 <> []
         then
           (let uu____5605 = FStar_Util.string_of_int total_decls  in
            FStar_Util.print1
         ...
         FStar_List.iter
           (fun uu____5620  ->
              ...
              | (m,n1) ->
                  if n1 <> (Prims.parse_int "0")
                  then
                    let uu____5636 = FStar_Util.string_of_int n1  in
                    FStar_Util.print2
...
let (mk_input :
  ...
  fun fresh  ->
    fun theory  ->
      ...
      (let uu____5695 = FStar_Options.print_z3_statistics ()  in
       if uu____5695 then context_profile theory else ());
      (let uu____5700 =
         let uu____5709 =
         ...
         then
             ...
             let uu____5731 =
               FStar_All.pipe_right theory
                 (FStar_Util.prefix_until
                    (fun uu___128_5759  ->
                       match uu___128_5759 with
                       | FStar_SMTEncoding_Term.CheckSat  -> true
                       | uu____5762 -> false))
                in
             FStar_All.pipe_right uu____5731 FStar_Option.get  in
           ...
           | (prefix1,check_sat,suffix) ->
               ...
               let hs =
                 let uu____5845 = FStar_Options.keep_query_captions ()  in
                 if uu____5845
                 then
                   let uu____5849 =
                     FStar_All.pipe_right prefix1
                      ...
                      in
                   FStar_All.pipe_right uu____5849 (FStar_String.concat "\n")
                 else ps  in
               let uu____5866 =
                 let uu____5870 = FStar_Util.digest_of_string hs  in
       ...
       | (r,hash) ->
           let log_file_name =
             let uu____5924 = FStar_Options.log_queries ()  in
             if uu____5924
             then
               let uu____5930 = query_logging.write_to_log fresh r  in
               FStar_Pervasives_Native.Some uu____5930
              ...
              fun fresh  ->
                ...
                let theory1 =
                  FStar_List.append theory
                   ...
                   in
                let uu____6148 = filter_theory theory1  in
                match uu____6148 with
                | (theory2,_used_unsat_core) ->
                    let uu____6158 = mk_input fresh theory2  in
                  ...
                  let uu____6268 =
                    ...
                    | FStar_Pervasives_Native.None  ->
                        (FStar_ST.op_Colon_Equals bg_scope [];
                         (let uu____6304 = FStar_ST.op_Bang fresh_scope  in
                          FStar_List.rev uu____6304))
                     in
                  FStar_List.flatten uu____6268  in
                let theory1 =
                  FStar_List.append theory
                    (FStar_List.append [FStar_SMTEncoding_Term.Push]
                       (FStar_List.append qry [FStar_SMTEncoding_Term.Pop]))
                   in
                let uu____6333 = filter_theory theory1  in
                match uu____6333 with
                | (theory2,used_unsat_core) ->
                    let uu____6343 = mk_input true theory2  in
          ...
          fun qry  ->
            fun scope  ->
              fun cb  ->
                fun fresh  ->
                  let uu____6461 =
                    let uu____6463 = FStar_Options.n_cores ()  in
