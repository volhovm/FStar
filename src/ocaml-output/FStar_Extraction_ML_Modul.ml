...
let (iface_of_bindings :
  ...
  =
  fun fvs  ->
    let uu___33_1302 = empty_iface  in
    {
      iface_module_name = (uu___33_1302.iface_module_name);
      iface_bindings = fvs;
      iface_tydefs = (uu___33_1302.iface_tydefs);
      iface_type_names = (uu___33_1302.iface_type_names)
    }
  
let (iface_of_tydefs : FStar_Extraction_ML_UEnv.tydef Prims.list -> iface) =
  fun tds  ->
    let uu___34_1313 = empty_iface  in
    let uu____1314 =
      FStar_List.map (fun td  -> td.FStar_Extraction_ML_UEnv.tydef_fv) tds
       in
    {
      iface_module_name = (uu___34_1313.iface_module_name);
      iface_bindings = (uu___34_1313.iface_bindings);
      iface_tydefs = tds;
...
let (iface_of_type_names : FStar_Syntax_Syntax.fv Prims.list -> iface) =
  fun fvs  ->
    let uu___35_1329 = empty_iface  in
    {
      iface_module_name = (uu___35_1329.iface_module_name);
      iface_bindings = (uu___35_1329.iface_bindings);
      iface_tydefs = (uu___35_1329.iface_tydefs);
    ...
    fun modul  ->
      ...
      then (g, empty_iface)
        ...
        (let uu____3349 = FStar_Options.restore_cmd_line_options true  in
         ...
         let iface1 =
           let uu___36_3353 = empty_iface  in
           {
             iface_module_name = (g.FStar_Extraction_ML_UEnv.currentModule);
             iface_bindings = (uu___36_3353.iface_bindings);
             iface_tydefs = (uu___36_3353.iface_tydefs);
             iface_type_names = (uu___36_3353.iface_type_names)
           }  in
         let res =
    ...
    fun iface1  ->
         ...
         in
      {
        FStar_Extraction_ML_UEnv.env_tcenv =
          (uu___37_3442.FStar_Extraction_ML_UEnv.env_tcenv);
        ...
        FStar_Extraction_ML_UEnv.currentModule =
          (uu___37_3442.FStar_Extraction_ML_UEnv.currentModule)
      }
                ...
                let postprocess_lb tau lb =
                  let lbdef =
                    FStar_TypeChecker_Env.postprocess
                     ...
                     in
                  let uu___38_5075 = lb  in
                  {
                    FStar_Syntax_Syntax.lbname =
                      (uu___38_5075.FStar_Syntax_Syntax.lbname);
                    FStar_Syntax_Syntax.lbunivs =
                      (uu___38_5075.FStar_Syntax_Syntax.lbunivs);
                    FStar_Syntax_Syntax.lbtyp =
                      (uu___38_5075.FStar_Syntax_Syntax.lbtyp);
                    FStar_Syntax_Syntax.lbeff =
                      (uu___38_5075.FStar_Syntax_Syntax.lbeff);
                    FStar_Syntax_Syntax.lbdef = lbdef;
                    FStar_Syntax_Syntax.lbattrs =
                      (uu___38_5075.FStar_Syntax_Syntax.lbattrs);
                    FStar_Syntax_Syntax.lbpos =
                      (uu___38_5075.FStar_Syntax_Syntax.lbpos)
                  }  in
                let lbs1 =
                  let uu____5084 =
                    match post_tau with
                                           ...
                                           (let lb_lid =
                                            ...
                                            let meta =
                                              FStar_List.append flags1
                                               ...
                                               in
                                            let ml_lb1 =
                                              let uu___39_5314 = ml_lb  in
                                              {
                                                FStar_Extraction_ML_Syntax.mllb_name
                                                  =
                                                  (uu___39_5314.FStar_Extraction_ML_Syntax.mllb_name);
                                                FStar_Extraction_ML_Syntax.mllb_tysc
                                                  =
                                                  (uu___39_5314.FStar_Extraction_ML_Syntax.mllb_tysc);
                                                FStar_Extraction_ML_Syntax.mllb_add_unit
                                                  =
                                                  (uu___39_5314.FStar_Extraction_ML_Syntax.mllb_add_unit);
                                                FStar_Extraction_ML_Syntax.mllb_def
                                                  =
                                                  (uu___39_5314.FStar_Extraction_ML_Syntax.mllb_def);
                                                FStar_Extraction_ML_Syntax.mllb_meta
                                                  = meta;
                                                FStar_Extraction_ML_Syntax.print_typ
                                                  =
                                                  (uu___39_5314.FStar_Extraction_ML_Syntax.print_typ)
                                              }  in
                                            let uu____5315 =
                                              let uu____5320 =
                                                FStar_All.pipe_right quals
                                                    ...
                                                    (env1,
                                                      (let uu___40_5381 =
                                                         ml_lb1  in
                                                       {
                                                         ...
                                                         FStar_Extraction_ML_Syntax.mllb_tysc
                                                           =
                                                           (uu___40_5381.FStar_Extraction_ML_Syntax.mllb_tysc);
                                                         FStar_Extraction_ML_Syntax.mllb_add_unit
                                                           =
                                                           (uu___40_5381.FStar_Extraction_ML_Syntax.mllb_add_unit);
                                                         FStar_Extraction_ML_Syntax.mllb_def
                                                           =
                                                           (uu___40_5381.FStar_Extraction_ML_Syntax.mllb_def);
                                                         FStar_Extraction_ML_Syntax.mllb_meta
                                                           =
                                                           (uu___40_5381.FStar_Extraction_ML_Syntax.mllb_meta);
                                                         FStar_Extraction_ML_Syntax.print_typ
                                                           =
                                                           (uu___40_5381.FStar_Extraction_ML_Syntax.print_typ)
                                                       }))
                                              else
                                                (let uu____5388 =
                                                   let uu____5396 =
             ...
             let always_fail1 =
                 ...
                 FStar_Syntax_Syntax.Sig_let uu____5485  in
               {
                 ...
                 FStar_Syntax_Syntax.sigrng =
                   (uu___41_5483.FStar_Syntax_Syntax.sigrng);
                 FStar_Syntax_Syntax.sigquals =
                   (uu___41_5483.FStar_Syntax_Syntax.sigquals);
                 FStar_Syntax_Syntax.sigmeta =
                   (uu___41_5483.FStar_Syntax_Syntax.sigmeta);
                 FStar_Syntax_Syntax.sigattrs =
                   (uu___41_5483.FStar_Syntax_Syntax.sigattrs)
               }  in
       ...
       let g1 =
            ...
            in
         {
           ...
           FStar_Extraction_ML_UEnv.env_bindings =
             (uu___42_5674.FStar_Extraction_ML_UEnv.env_bindings);
           FStar_Extraction_ML_UEnv.tydefs =
             (uu___42_5674.FStar_Extraction_ML_UEnv.tydefs);
           FStar_Extraction_ML_UEnv.type_names =
             (uu___42_5674.FStar_Extraction_ML_UEnv.type_names);
