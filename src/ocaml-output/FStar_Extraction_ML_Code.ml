                ...
                then "\\n"
                  ...
                  then "\\'"
                    ...
                    then "\\\""
                      ...
                      if FStar_Util.is_letter_or_digit uu___12_1710
                      then FStar_Util.string_of_char uu___12_1710
                      else
                        if FStar_Util.is_punctuation uu___12_1710
                        then FStar_Util.string_of_char uu___12_1710
                        else
                          if FStar_Util.is_symbol uu___12_1710
                          then FStar_Util.string_of_char uu___12_1710
                          else fallback uu___12_1710
